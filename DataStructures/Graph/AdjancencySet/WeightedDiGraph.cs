...
namespace DataStructures.Graph.AdjancencySet
{
		...
		where TW:IComparable
	{
		...
		public void AddVertex(T key)
		{
			...
			var newVartex = new WeightedDiGraphVertex<T,TW>(key);
		...
		public void RemoveVertex(T key)
		{
			...
			foreach (var vertex in vertices[key].InEdges)//Her defasında bir düğüm verir
				vertex.Key.InEdges.Remove(vertices[key]);
			foreach (var vertex in vertices[key].OutEdges)//Her defasında bir düğüm verir
